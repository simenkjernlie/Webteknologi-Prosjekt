...
// funksjon som konverterer datostrenger til riktig format
function parseDate(str) {
    var mdy = str.split('/');
    return new Date(mdy[2], mdy[0] - 1, mdy[1]);
}

// måle forskjellen to datoer og dele på antall millisekunder pr dag, runder av til nærmeste hele tall for å håndtere DST
// inspirert fra StackOverflow: https://stackoverflow.com/questions/542938/how-do-i-get-the-number-of-days-between-two-dates-in-javascript
function datediff(first, second) {
    return Math.round((second - first) / (1000 * 60 * 60 * 24));
}

// Tar inn to datoer og sjekker om disse oppfyller kriteriene for å bestille hotell 
//          - at datoene er i fremtid
//          - at check in er før check out
...
// Funksjon som benyttes for å ha interaktiv Google maps API
